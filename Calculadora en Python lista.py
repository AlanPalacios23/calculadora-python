...
class Calculadora:
    def __init__(self, root):
        ...
        self.entrada = tk.Entry(
            root, width=17, font=("arial", 28), borderwidth=0,
    ...
    def crear_botones(self):
        ...
        for boton, span in botones:
            ...
            btn = tk.Button(
                frame_botones, text=boton, width=5 * span, height=2,
                font=("arial", 20), bg=color_fondo, fg=colores_botones["texto"],
                borderwidth=0, command=lambda b=boton: self.click_boton(b)
            )
